...
export function identitiesDeleteIdentity(
  ...
  Result<
    components.V2IdentitiesDeleteIdentityResponseBody,
...
> {
  ...
  const path = pathToFunc("/v2/identities.deleteIdentity")();
  ...
  >(
    M.json(
      200,
      components.V2IdentitiesDeleteIdentityResponseBody$inboundSchema,
    ),
