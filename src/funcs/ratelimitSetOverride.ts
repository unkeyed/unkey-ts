...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2RatelimitSetOverrideRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/ratelimit.setOverride")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.RatelimitSetOverrideResponse$inboundSchema, {
